...
@CommandLine.Command(name = "Manufacturing Services Planner",
        version = "Manufacturing Services Planner 1.0",
...
public class ManufacturingServicesPlanner extends AbstractPlanner {

    private static final Logger LOGGER = LogManager.getLogger(ManufacturingServicesPlanner.class.getName());
     ...
     * viene istanziato l’oggett, della classe DefaultParsedProblem
    ...
    public Plan solve(final Problem problem) throws ProblemNotSupportedException {
        ...
        if (this.getHeuristicNew() == 1){
            ...
            LOGGER.info("* Starting A* Search with Manufacturing Services Heuristic \n");
    ...
    public Plan customAstar(Problem problem){
        ...
        ManufacturingServicesHeuristic heuristic = new ManufacturingServicesHeuristic(problem);
    ...
    public static void main(String[] args) {
        try {
            final ManufacturingServicesPlanner planner = new ManufacturingServicesPlanner();
