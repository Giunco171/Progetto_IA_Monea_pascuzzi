...
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN1 $PROBLEM1 >> results/21/a_ff_result.txt

echo "A* con euristica AJUSTED_SUM"
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN1 $PROBLEM1 -e AJUSTED_SUM >> results/21/a_as_result.txt

echo "A* con euristica personalizzata"
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN1 $PROBLEM1 -en 1 >> results/21/a_msh_result.txt
...
echo "A* con euristica FastForward"
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN2 $PROBLEM2 >> results/22/a_ff_result.txt

echo "A* con euristica AJUSTED_SUM"
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN2 $PROBLEM2 -e AJUSTED_SUM >> results/22/a_as_result.txt

echo "A* con euristica personalizzata"
java -cp classes:lib/pddl4j-4.0.0.jar ManufacturingServicesPlanner $DOMAIN2 $PROBLEM2 -en 1 >> results/22/a_msh_result.txt
