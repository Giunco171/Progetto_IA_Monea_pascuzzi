...
class FillBoxInLoc : public plansys2::ActionExecutorClient
{
public:
  FillBoxInLoc()
  : plansys2::ActionExecutorClient("fillboxinloc", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<FillBoxInLoc>();

  node->set_parameter(rclcpp::Parameter("action_name", "FILLBOXINLOC"));
