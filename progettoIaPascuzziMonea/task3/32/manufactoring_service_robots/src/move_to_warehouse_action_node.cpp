...
class MoveToWarehouse : public plansys2::ActionExecutorClient
{
public:
  MoveToWarehouse()
  : plansys2::ActionExecutorClient("movetowarehouse", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<MoveToWarehouse>();

  node->set_parameter(rclcpp::Parameter("action_name", "MOVETOWAREHOUSE"));
