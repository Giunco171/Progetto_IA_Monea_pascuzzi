...
class PutDownBoxInLoc : public plansys2::ActionExecutorClient
{
public:
  PutDownBoxInLoc()
  : plansys2::ActionExecutorClient("putdownboxinloc", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<PutDownBoxInLoc>();

  node->set_parameter(rclcpp::Parameter("action_name", "PUTDOWNBOXINLOC"));
