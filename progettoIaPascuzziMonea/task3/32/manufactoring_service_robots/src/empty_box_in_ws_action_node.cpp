...
class EmptyBoxInWs : public plansys2::ActionExecutorClient
{
public:
  EmptyBoxInWs()
  : plansys2::ActionExecutorClient("emptyboxinws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<EmptyBoxInWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "EMPTYBOXINWS"));
