...
class PutDownBoxInWs : public plansys2::ActionExecutorClient
{
public:
  PutDownBoxInWs()
  : plansys2::ActionExecutorClient("putdownboxinws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<PutDownBoxInWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "PUTDOWNBOXINWS"));
