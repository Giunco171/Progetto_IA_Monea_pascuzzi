...
class MoveToLoc : public plansys2::ActionExecutorClient
{
public:
  MoveToLoc()
  : plansys2::ActionExecutorClient("movetoloc", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<MoveToLoc>();

  node->set_parameter(rclcpp::Parameter("action_name", "MOVETOLOC"));
