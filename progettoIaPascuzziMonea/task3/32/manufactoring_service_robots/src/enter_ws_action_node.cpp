...
class EnterWs : public plansys2::ActionExecutorClient
{
public:
  EnterWs()
  : plansys2::ActionExecutorClient("enterws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<EnterWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "ENTERWS"));
