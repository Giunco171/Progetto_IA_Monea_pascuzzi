...
class ExitWs : public plansys2::ActionExecutorClient
{
public:
  ExitWs()
  : plansys2::ActionExecutorClient("exitws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<ExitWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "EXITWS"));
