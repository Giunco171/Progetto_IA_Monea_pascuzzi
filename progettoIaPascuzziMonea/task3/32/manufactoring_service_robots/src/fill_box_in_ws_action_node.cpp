...
class FillBoxInWs : public plansys2::ActionExecutorClient
{
public:
  FillBoxInWs()
  : plansys2::ActionExecutorClient("fillboxinws", 250ms)
  {
    progress_ = 0.0;
  }
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<FillBoxInWs>();

  node->set_parameter(rclcpp::Parameter("action_name", "FILLBOXINWS"));
